...
%nsteps = [1000000];
%nsteps = round(linspace(500,1000,100)); 
nsteps = round(linspace(5000,10000,100));
...
for i= 1:nsimul
    ...
    error(i)=abs(distanceTerre(Ivi)+rT+rA-mini(i));
