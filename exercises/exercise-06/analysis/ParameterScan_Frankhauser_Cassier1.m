...
input = 'configuration1.in';
N2       = floor(linspace(100, 1000, 10));
N1       = [1 2 3 4 5];
...
for k=1:nN2
    ...
    NA=zeros(1, nN1);
    NA=N1.*N2(k);
    plot(1./(NA.^2), phib,'+-','linewidth',lw)
    hold on;
    names(k)= num2str(N2(k));
end
ylabel('$\phi (r)$ $[V]$')
xlabel('$1/N_1^2$')
legend(names);
